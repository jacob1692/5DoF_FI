#ifndef _ROS_mouse_perturbation_robot_MouseMsg_h
#define _ROS_mouse_perturbation_robot_MouseMsg_h
...
namespace mouse_perturbation_robot
{

  class MouseMsg : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "mouse_perturbation_robot/MouseMsg"; };
    const char * getMD5(){ return "c8b256345673229922e013ff820cd8d0"; };
