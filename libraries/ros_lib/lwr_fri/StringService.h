#ifndef _ROS_SERVICE_StringService_h
#define _ROS_SERVICE_StringService_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char STRINGSERVICE[] = "lwr_fri/StringService";

  class StringServiceRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return STRINGSERVICE; };
    const char * getMD5(){ return "994972b6e03928b2476860ce6c4c8e17"; };

  };

  class StringServiceResponse : public ros::Msg
  {
    public:
      typedef const char* _str_type;
      _str_type str;
